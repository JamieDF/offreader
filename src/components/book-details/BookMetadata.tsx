        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4 text-center mb-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground uppercase">{book.format === 'PDF' || book.format === 'CBZ' ? 'Pages' : 'Chapters'}</p>
            ...
            <div className="grid grid-cols-2 gap-4 text-center pt-4 border-t border-border/50">
              {book.pageCount && (
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground uppercase">{book.format === 'PDF' || book.format === 'CBZ' ? 'Pages' : 'Est. Pages'}</p>
