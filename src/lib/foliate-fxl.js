// Based on fixed-layout.js from foliate-js (MIT) — https://github.com/johnfactotum/foliate-js
// Taken from the npm package (foliate-js/fixed-layout.js).
// Modifications:
//   - Added reload() method: resets #index to -1 then calls goToSpread() to force
//     a full section reload on the current page (required for PDF rotation to take effect,
//     since goToSpread() early-returns without reloading when already on the target spread)
...
export class FixedLayout extends HTMLElement {
    ...
    // Force the current spread to reload from scratch (e.g. after rotation change)
    async reload() {
