// Based on view.js from foliate-js (MIT) — https://github.com/johnfactotum/foliate-js
// Source file is not exported from the npm package; taken from the GitHub repository.
// Modifications:
//   - Import paths rewritten from relative to package-qualified (foliate-js/*)
//     so Vite resolves them via node_modules rather than src/lib/
//   - Added isPDF() helper and the PDF routing branch in makeBook() that
//     delegates to ./foliate-pdf.js (PDF support does not exist in upstream)
